  ...
  theme: {
    colors: {
      ...
      success: {
        ...
        "gradient-500": "linear-gradient(0deg, rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.05)), linear-gradient(180deg, #23C277 0%, #399D6C 100%)",
      ...
      info: {
        ...
        100: "#084B8A",
        50: "#F6F9FD",
        "gradient-400": "inear-gradient(360deg, #116AB8 0%, #0788DE 100%)",
        "gradient-500": "llinear-gradient(0deg, rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.05)), linear-gradient(360deg, #116AB8 0%, #0788DE 100%)",
      ...
      warning: {
        ...
        "gradient-500": "linear-gradient(0deg, rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.05)), linear-gradient(180deg, #EE9913 0%, #D9822B 100%)",
      ...
      danger: {
        ...
        "gradient-500": "linear-gradient(0deg, rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.05)), linear-gradient(180deg, #F16F4F 0%, #EC4C47 100%)",
